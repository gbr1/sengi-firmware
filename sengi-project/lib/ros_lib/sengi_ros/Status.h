#ifndef _ROS_sengi_ros_Status_h
#define _ROS_sengi_ros_Status_h
...
namespace sengi_ros
{
  ...
  class Status : public ros::Msg
  {
    ...
    const char * getType(){ return "sengi_ros/Status"; };
    const char * getMD5(){ return "3a5308053d8356e587cb07d69c689fff"; };
