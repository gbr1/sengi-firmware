#ifndef _ROS_mymsg_myuss1_h
#define _ROS_mymsg_myuss1_h
...
namespace mymsg
{
  ...
  class myuss1 : public ros::Msg
  {
    ...
    const char * getType(){ return "mymsg/myuss1"; };
    const char * getMD5(){ return "4c739b0ad83c2914df6d41fe1b87d25f"; };
